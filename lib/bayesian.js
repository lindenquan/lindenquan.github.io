...
var Node = function () {
    ...
    _createClass(Node, [{
        ...
        value: function sendMessage(node, seperator) {
            var commonVarNames = Tool.arrayIntersect(this.distr.varNames, node.distr.varNames);
        ...
        value: function runHugin() {
            ...
            var _loop = function _loop() {
                ...
                leaves.forEach(function (leaf) {
                    ...
                    leaf.sendMessage(father, _this.findSeperator(leaf, father));
                    if (father != root) {
            ...
            var _loop2 = function _loop2() {
                ...
                children.forEach(function (child) {
                    child.father.sendMessage(child, _this.findSeperator(child.father, child));
